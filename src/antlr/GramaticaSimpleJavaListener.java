...
public interface GramaticaSimpleJavaListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link GramaticaSimpleJavaParser#Number}.
	 * @param ctx the parse tree
	 */
	void enterNumber(@NotNull GramaticaSimpleJavaParser.NumberContext ctx);
	/**
	 * Exit a parse tree produced by {@link GramaticaSimpleJavaParser#Number}.
	 * @param ctx the parse tree
	 */
	void exitNumber(@NotNull GramaticaSimpleJavaParser.NumberContext ctx);
	...
	/**
	 * Enter a parse tree produced by {@link GramaticaSimpleJavaParser#operadorRelacional}.
	 * @param ctx the parse tree
	 */
	void enterOperadorRelacional(@NotNull GramaticaSimpleJavaParser.OperadorRelacionalContext ctx);
	/**
	 * Exit a parse tree produced by {@link GramaticaSimpleJavaParser#operadorRelacional}.
	 * @param ctx the parse tree
	 */
	void exitOperadorRelacional(@NotNull GramaticaSimpleJavaParser.OperadorRelacionalContext ctx);
